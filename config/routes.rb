...
Rails.application.routes.draw do
    ...
    resources :representatives do
        ...
        #get '/representatives/:representative_id/my_news_item/select',
        #to: 'my_news_items#select_representative_and_issue',
        #as: :select_representative_and_issue
        
        #post '/representatives/:representative_id/my_news_item/search',
        ...
        get '/representatives/:representative_id/my_news_item/select' => 'my_news_items#select',
        :as => :select_my_news_item

        get '/representatives/:representative_id/my_news_item/make' => 'my_news_items#make',
        :as => :make_my_news_item

        get '/representatives/:representative_id/my_news_item/:id/delete' => 'my_news_items#destroy',
        :as => :delete_my_news_item

        delete '/representatives/:representative_id/my_news_item/:id/delete' => 'my_news_items#destroy',
        :as => :delete_delete_my_news_item
